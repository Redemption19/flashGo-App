 ...
 static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
{
    ...
    //USD
    double totalFareAmountInUSD = timeTraveledFareAmountPerMinute + distanceTraveledFareAmountPerKilometer;

    // Exchange rate from USD to GHS
    double exchangeRate = 9.0; // Assuming 1 USD = 6.5 GHS

    // Convert to GHS
    double totalFareAmountInGHS = totalFareAmountInUSD * exchangeRate;

    return double.parse(totalFareAmountInGHS.toStringAsFixed(1));
}
